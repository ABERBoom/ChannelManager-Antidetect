(function() {
    ...
    console.log('[WebRTC Guard] Active, spoofing to:', TARGET_PROXY_IP);
    ...
    function spoofSDP(sdp) {
        ...
        if (!hasPublic) {
            ...
            if (insertIdx !== -1) {
                let fakeCandidate = `a=candidate:842163049 1 udp 1677729535 ${TARGET_PROXY_IP} 53421 typ srflx raddr 0.0.0.0 rport 0 generation 0`;
                    ...
                    const wrapper = function(event) {
                        if (event.candidate) {
                            ...
                            if (!this._hasSpoofedPublicIp) {
                                let fakeCandidateStr = `candidate:842163049 1 udp 1677729535 ${TARGET_PROXY_IP} 53421 typ srflx raddr 0.0.0.0 rport 0 generation 0`;
